        ...
        <div className="col-span-7 place-self-start justify-items-end translate-y-[50px]">
          ...
          <div>
            ...
            <Link href="#projects" passHref>
              <button className="group relative px-6 py-3 w-60 h-[70px] rounded-full bg-transparent text-white ml-[50px] mt-10 text-2xl font-bold border-4 border-white overflow-hidden hover:shadow-lg hover:bg-white hover:border-purple-500 transition duration-300 ease-in-out">
